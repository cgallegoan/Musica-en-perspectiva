...
excludes = c(3, 10, 15)
pop_filter = 60  #Filtro de popularidad
year_min_filter = 2010  #Filtro de año (menor)
year_max_filter = 2021   #Filtro de año (mayor)
...
clustering_2 <- kmeans(songs, centers = 3, nstart = 50, iter.max = 50)
...
plot(silhouette(clustering_2$cluster, midist), col=rainbow(3), border=NA, main = "K-medias")
...
boxplot(data$popularity ~ factor(clustering_2$cluster), col = rainbow(3))
